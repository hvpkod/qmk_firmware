...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
    ...
    [0] = LAYOUT(
        ...
        KC_LSFT,    KC_Z,    KC_X,    KC_C,    KC_V,        KC_B,    KC_N,    KC_M,    KC_COMM, KC_DOT, TD(TD3),
        KC_LCPO,    KC_LGUI, KC_LALT,   LT(2,KC_ENT),       LT(1,KC_SPC),              KC_RAPC,   TD(TD2),   KC_SFTENT
    ),
    ...
    [3] = LAYOUT(
        ...
        KC_DEL, _______,   _______,   D_NAVI,   KC_LCTL,  _______,  KC_LEFT, KC_DOWN, KC_UP, KC_RGHT, _______,
    ...
    [4] = LAYOUT(
        ...
        KC_PSCR,    RGB_VAD,    RGB_SAD,    RGB_SAI,    _______,    KC_0,       KC_1,       KC_2, KC_3,     _______,    _______,
        RESET,      RGB_VAI,    _______,    _______,    _______,    _______,    _______,    _______
    )
